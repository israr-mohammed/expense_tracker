...
- Response contains the seed user's email ("demo@expensetracker.com")
...
## Definition of done
- [ ] Logging in as the seed user (demo@expensetacker.com / demo123) shows "Demo User" and "demo@expensetracker.com" on the profile page — not the hardcoded strings
